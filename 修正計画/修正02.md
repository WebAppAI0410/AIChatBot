...
| **1** (Low-cost) | GPT-4o-mini, GPT-4.1-mini/nano, DeepSeek V3, DeepSeek R1, Gemini 2.5 Flash Preview, o3, o4-mini, o4-mini-high | $0.0005 – 0.010 | 60 rpm | Lite / fallback用 |
| **2** (Premium) | GPT-4o, GPT-4.1, Gemini 2.5 Pro Preview, GPT-4.5 Preview, Claude 3.7 Sonnet | $0.010 – 0.040 | 60 rpm | Premium枠・Freeは 1 msg/日 |
...
- `constants/models.ts` - モデル定義とTier分類
  ...
  export const MODELS = {
    ...
    'openrouter/auto': { tier: 0, name: 'Auto (最適なモデルを自動選択)', provider: 'openrouter', isAuto: true },
    // Tier 0 (Free)
    'google/gemini-2.5-pro-exp': { tier: 0, name: 'Gemini 2.5 Pro Exp', provider: 'google' },
    'deepseek/deepseek-r1-zero': { tier: 0, name: 'DeepSeek R1 Zero', provider: 'deepseek' },
    // Tier 1 (Low-cost)
    'openai/gpt-4o-mini': { tier: 1, name: 'GPT-4o mini', provider: 'openai' },
    'openai/gpt-4.1-mini': { tier: 1, name: 'GPT-4.1 mini', provider: 'openai' },
    // Tier 1 (Lite 限定)
    'openai/o3': { tier: 1, name: 'o3', provider: 'openai' },
    'openai/o4-mini': { tier: 1, name: 'o4-mini', provider: 'openai' },
    'openai/o4-mini-high': { tier: 1, name: 'o4-mini-high', provider: 'openai' },
    // Tier 2 (Premium)
    'openai/gpt-4o': { tier: 2, name: 'GPT-4o', provider: 'openai' },
    'anthropic/claude-3.7-sonnet': { tier: 2, name: 'Claude 3.7 Sonnet', provider: 'anthropic' },
    'anthropic/claude-3.7-sonnet:thinking': { tier: 2, name: 'Claude 3.7 Sonnet Thinking', provider: 'anthropic' },
    // ローカルモデル
